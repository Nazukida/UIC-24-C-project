    ...
    while (1)
    {
        ...
        while (1)
        {
            ...
            }else if (input == 4)
            {
                ...
                return;//this one could let user choose whether to continue or quit
            }else
            {
...
// void book(struct classroom b, int a)
// {
//     if (b.can_book_0[a] == '1')
//     {
//         b.can_book_0[a] -= 1;
//         FILE *fp;
//         fp = fopen(b.filename, "w");
//         fputs(b.can_book, fp);
//         fclose;
//     }
//     else
//         printf("The classroom has been booked!\n");
//     return;
// }
...
void today_judge(void) {
    ...
    else if (tblock->tm_hour >= 9 && tblock->tm_hour < 12) {
        int num = 1;
    ...
    else if (tblock->tm_hour >= 12 && tblock->tm_hour < 17) {
        int num = 1;
        for (int i = tblock->tm_hour; i <= 17; i++) {
            if (i == 15) {
                continue;
